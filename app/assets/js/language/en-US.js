let langDownload = 'Download'
let langGenerating = 'Generating... '
let langGenerated = 'generated'
let langSetMarker = 'Set at least one marker'
let langSelectAudio = 'Select an audio first'
let langSupportedLength = 'Only audio files with a length of up to one hour are supported'
let langInvalidLicense = 'The license key is invalid. Please check for any typing errors.'
let langNoInternet = 'You are not connected to the internet. Please establish an internet connection to actrivate the license.'
let langNoServerConnection = 'Can not establish connection to the server. If this error occurs longer, try to upadate the software.'
let langInUse = 'Another device is currently using the program. Please close it, as only one program can use the license at the same time.'
let langUpdateAvailable = 'A new update is available. Downloading now...'
let langUpdateDone = 'Update Downloaded. It will be installed on restart. Restart now?'
